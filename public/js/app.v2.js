/*
 * Amorvia — app.v2.js (Continuum Fix v9.7.2p+ • ES2018-safe • v972p22)
 * Fix: ensure all regex literals are not double-escaped (e.g., \s not \\s),
 * and remove modern syntax that could break older parsers.
 */
