...
// Provides named exports AND exposes window.AmorviaMetrics.
// Safe for CSP, no inline code required.
...
export function track(name, data = {}, extraCtx = {}) {
...
// Also expose as global for non-module callers
try {
  if (typeof window !== 'undefined') {
    window.AmorviaMetrics = Metrics;
    appInit();
  }
} catch {}
