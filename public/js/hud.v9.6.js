...
// Amorvia HUD v9.6 — renders Trust/Tension/Child Stress into #hud
(function(){
  'use strict';
  ...
  function makeCard(key, label){
    ...
    row.appendChild(badge); row.appendChild(val);
  ...
  function ensureHud(){
    ...
    return host.__hudRefs;
  }

  function render(state){
    const refs = ensureHud();
    if (!refs) return;
  ...
  // Bind to engine if it exposes updateHud
