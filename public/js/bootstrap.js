...
if (modeSel) { modeSel.value = getMode(); applyModeToDOM(modeSel.value); modeSel.addEventListener('change', () => { localStorage.setItem('amorvia:mode', modeSel.value); location.reload(); }); }
