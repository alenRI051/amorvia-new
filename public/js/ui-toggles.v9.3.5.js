...
// ui-toggles.v9.3.5.js — High contrast, Reset UI, Restart Act + shortcuts
(function(){
  ...
  function init(){
    ...
    window.addEventListener('keydown', (e)=>{
      ...
      if (e.key.toLowerCase() === 'h') { e.preventDefault(); toggleContrast(); }
      if (e.key.toLowerCase() === 'r' && e.shiftKey) { e.preventDefault(); resetUI(); }
      else if (e.key.toLowerCase() === 'r') { e.preventDefault(); restartAct(); }
    });
  }
