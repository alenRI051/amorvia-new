// Amorvia HUD Combined — v9.6.9 (overwrite)
// Strong hook: scrubs legacy tokens at the insertion point and updates HUD.
(function(){
  'use strict';
  ...
  function patchDialogInsertion(dialog){
    ...
    // Patch instance-level innerHTML setter
    ...
    // Patch common mutators on the instance
    const wrap = (obj, name)=>{
      const fn = obj[name];
      ...
      obj[name] = function(...args){
        ...
        // Also scrub any newly inserted nodes
    ...
    // Observe any other external writes
  ...
  function hookEngine(){
    ...
    // Also wrap engine high-level methods to be safe
